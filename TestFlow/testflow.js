...
const SourceCodeFile = '../functions/skill/index.js';
...
async function prepareTestRequest(sa, newSession, request){
    ...
    if (SourceLang === 'javascript') {
        ...
        if (options.stdout) {
            ...
            let data = await MyLambdaFunction[handlerName] (eventJSON, context, callback);
